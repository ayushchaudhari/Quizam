...
from transformers import BertTokenizer,BertModel,BertConfig,BertPreTrainedModel,BertTokenizer,T5ForConditionalGeneration,T5Tokenizer
...
def supwsd_api_get_sense(sent):
    for result in SupWSD('SM9XaFlRF9').disambiguate(sent, Model.SEMCOR_EXAMPLES_GLOSSES_ONESEC_OMSTI, Language.EN):
        ...
        # print(SupWSD.SENSE_TAG)
        return(syn,syn.definition(),token.word)
